<template>
  <div>
    ...
    <el-dialog v-if="yunDialog" title="腾讯云中的图片" :visible.sync="yunDialog" width="40%">
      <el-row>
        <el-col :span="4" v-for="item in cosImgs" :key="item.key">
          <el-image
            :src="'https://hefuhui-1258205592.cos.ap-guangzhou.myqcloud.com/'+item.Key"
            fit="cover"
          ></el-image>
        </el-col>
      </el-row>
